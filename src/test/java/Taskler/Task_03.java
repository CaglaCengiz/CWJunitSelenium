...
public class Task_03 extends BaseTest {
    ...
    public void dismissAlert() {
        ...
        jsConfirm.click();
        driver.switchTo().alert().dismiss();//reddetmek anlamında
    ...
    public void sendKeysAlert() {
        ...
        driver.switchTo().alert().accept();//kabul etmek anlamında
        Assert.assertTrue(driver.findElement(By.id("result")).getText().contains("Cagla"));
    }
}
